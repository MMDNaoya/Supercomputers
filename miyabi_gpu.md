...
# condaによる環境作成
# conda -n による環境作成は結局quota exceed errorが生じる．/workは定期的に削除されるのでパッケージ情報は/homeに保存すること
conda create --prefix /work/gq32/q32001/conda/ml_cpu python=3.11
conda activate conda activate /work/gq32/q32001/conda/ml_cpu

pip install torch torchvision --extra-index-url https://download.pytorch.org/whl/cu128
pip install huggingface albumentations # お好みのパッケージをインストールできる．
